var classes = [
    ...
    },
    {
      ...
      "description": "Special Topics in Computer Science to be announced.",
      "credit": 4,
      "unlock": [],
      "prereq": 0,
      "x": "585px",
    ...
    },
    {
      ...
      "description": "A student may enroll in this course to study computer science topics that are not available in a regular course.",
      "credit": 4,
      "unlock": [],
      "prereq": 0,
      "x": "491px",
    ...
    },
    {
      ...
      "description": "This course covers the history of computers and the computing that was instrumental to the eventual widespread use of computers in developed countries.",
      "credit": 3,
      "unlock": [],
      "prereq": 1,
      "x": "803px",
    ...
    },
    {
      ...
      "description": "This course provides a project and applications-oriented approach to parallel and distributed programming.",
      "credit": 3,
      "unlock": [],
      "prereq": 1,
      "x": "951.5px",
    ...
    },
    {
      ...
      "description": "he objective of this course is to teach the fundamental concepts, architectures, and protocols related to network security.",
      "credit": 3,
      "unlock": [],
      "prereq": 2,
      "x": "1060px",
